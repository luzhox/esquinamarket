jQuery(function ($) {
  $('body').vegas({
    slides: [{ src: login_imagenes.ruta_plantilla + '/login/img/1.jpg' }, { src: login_imagenes.ruta_plantilla + '/login/img/2.jpg' }, { src: login_imagenes.ruta_plantilla + '/login/img/3.jpg' }],
