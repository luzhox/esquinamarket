...
function PageModules(){for(var e=document.querySelectorAll("[data-module]"),t=0;t<e.length;t++){var r=e[t],a=r.getAttribute("data-module");try{var o=require("modules/"+a)}catch(u){var o=!1}o&&new o(r)}}module.exports=PageModules;
